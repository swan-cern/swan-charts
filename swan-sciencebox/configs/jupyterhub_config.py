...
class PodHookHandler:
    ...
    def _init_spark(spawner, pod):
        ...
        try:
            ...
            spawner.log.error("Could not create required user ports: %s\n" % e)
            raise Exception(c.SpawnHandlersConfigs.spawn_error_message)
    ...
    def _init_swan_secrets(spawner, pod):
        ...
        try:
            ...
            spawner.log.error("Could not create required user credential: %s\n" % e)
            raise Exception(c.SpawnHandlersConfigs.spawn_error_message)
        ...
        try:
            ...
            spawner.log.error("Could not create required user secret: %s\n" % e)
            raise Exception(c.SpawnHandlersConfigs.spawn_error_message)
